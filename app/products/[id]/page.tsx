...
export default async function ProductPage({ params }: { params: { id: string } }) {
  ...
  // Defensive defaults so you never crash if images is null/undefined
  const images = Array.isArray(product.images) ? product.images : []
  const mainImage =
    images[0] || "/placeholder.svg?height=800&width=800&query=silicone+baby+doll"
          ...
          {images.length > 1 && (
            <div className="grid grid-cols-4 gap-4">
              {images.slice(1, 5).map((image, i) => {
                const thumbSrc =
                  image || "/placeholder.svg?height=200&width=200&query=baby+view"
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-2 gap-6 pt-10 border-t">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Expert care instructions and starter kit included.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Hassle-free 14-day return policy for unused items.
              </p>
            </div>
          </div>
        </div>

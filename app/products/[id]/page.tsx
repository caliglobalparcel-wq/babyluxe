      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div className="space-y-4">
          <div className="relative aspect-square rounded-3xl overflow-hidden bg-slate-100 shadow-xl">
            <Image
              src={product.images[0] || "/placeholder.svg?height=800&width=800&query=silicone+baby+doll"}
              alt={product.name}
              fill
          ...
          {product.images.length > 1 && (
            <div className="grid grid-cols-4 gap-4">
              {product.images.slice(1, 5).map((image, i) => (
                <div key={i} className="relative aspect-square rounded-xl overflow-hidden bg-slate-100 cursor-pointer">
                  <Image
                    src={image || "/placeholder.svg?height=200&width=200&query=baby+view"}
        ...
        <div className="space-y-10">
          <div className="space-y-4">
            <div className="space-y-2">
              {product.featured && (
                <span className="text-primary font-bold uppercase tracking-widest text-xs">Featured Creation</span>
              )}
